...
public class AddActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    public void onClickButton(View view){
        ...
        try {
            ...
            insertValues.put("Filename",fileName);
    ...
    public boolean onQueryTextSubmit(String query){
        ...
        String url = this.getString(R.string.urlVal);
        try{
    ...
    public void callOMDB(){
        new MovieAsyncTaskOMDB().execute(new Info(this.searchString, this));
    }
    private String getMovie(String urlStr){
    ...
    private class MovieAsyncTaskOMDB extends AsyncTask<Info, Void, Info> {
        @Override
        protected Info doInBackground(Info... info) {

            String response =  getMovie("http://www.omdbapi.com/?t="+info[0].movie.replaceAll(" ", "%20")+"&y=&plot=short&r=json");
