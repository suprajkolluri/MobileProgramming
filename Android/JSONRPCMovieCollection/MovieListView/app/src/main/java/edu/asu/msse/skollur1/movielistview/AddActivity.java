...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            MethodInformation mi = new MethodInformation(this, url,"getGenreNames",
                    new String[]{});
            AsyncCollectionConnect ac = (AsyncCollectionConnect) new AsyncCollectionConnect().execute(mi);
        } catch (Exception ex){
            android.util.Log.w(this.getClass().getSimpleName(),"Exception getting genre names: "+
                    ex.getMessage());
        }
    }

    public void fillSpinner(List<String> list){
